note
	description: "Summary description for {EM_VALIDITY_JSON}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
	...
	validity_json: STRING_32 = "[
{
  "validity_codes": [
    ...
    },
    {
      "code": "VWOE",
      "category": "Usage",
      "description": "Once feature cannot be called on separate target. Check SCOOP usage.",
      "common_causes": [
        "Calling once feature in concurrent context",
        "Incorrect processor usage",
        "SCOOP constraint violation"
      ]
    }
  ]
}
